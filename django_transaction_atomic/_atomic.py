...
def get_connection(using=None):
    ...
    return ProxyDatabaseWrapper(connections[using])
...
class Atomic(ContextDecorator):
    ...
    def __enter__(self):
        ...
        if not connection.in_atomic_block:
            ...
            if not connection.get_autocommit():
                ...
                # code that disables autocommit to enter a transaction, and
                # make a note to deal with this case in __exit__.
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        ...
        if connection.savepoint_ids:
            ...
            # Prematurely unset this flag to allow using commit or
            # rollback.
        ...
        try:
            if connection.closed_in_transaction:
                ...
                connection.needs_rollback = False
                if connection.in_atomic_block:
                    # Roll back to savepoint if there is one, mark for
                    # rollback otherwise.
                    if sid is None:
                        connection.needs_rollback = True
                    else:
                    ...
                    try:
                        ...
                        # An error during rollback means that something went
